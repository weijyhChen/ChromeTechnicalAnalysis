...
/* 
	...
	以下程式是改寫綜合範例3的 window.onload 函式，使該
	函式利用分門別類整理過的函式的結果。
	由於綜合範例4有它自己的 window.onload 函式，所以這
	裡的 window.onload 必須註解掉，以免影響綜合範例4。
	如果要再測試綜合範例3改寫的程式，只要把 main.js 中
	的 window.onload 註解掉，然後把這裡的註解拿掉就可
	以再次測試綜合範例3了。
*/
